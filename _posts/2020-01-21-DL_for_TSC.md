...
### Note:
This article is based on a [story](https://medium.com/@stylianouvasilis/deep-learning-for-time-series-classification-inceptiontime-245703f422db) I posted on medium.com, which was further published at a number of journals, such as [Noteworthy - The Journal Blog](https://blog.usejournal.com/).
...
![receptive_field]({{ site.url }}{{ site.baseurl }}/images/dl_for_tsc_figures/receptive_field.png){:height="50%" width="50%"}<br/>
