...
![inception_module]({{ site.url }}{{ site.baseurl }}/images/dl_for_tsc_figures/inception_module.png){:height="50%" width="100%"}*Fig. 1: The Inception module of InceptionTime.{: .text-center}*
