...
```
![img1]({{ site.url }}{{ site.baseurl }}/images/sql_visualizations/output_11_0.png)
...
![img2]({{ site.url }}{{ site.baseurl }}/images/sql_visualizations/output_18_0.png){: style="max-width: 500px; height: auto;"}
...
![img3]({{ site.url }}{{ site.baseurl }}/images/sql_visualizations/output_22_0.png)
