...
At first glance, the graph suggests that there is a hierarchy among the performance of sales employees based on their hiring date. However given the time difference among all employees, we expect Steve Johnson to (soon) outperform Margaret Park.
